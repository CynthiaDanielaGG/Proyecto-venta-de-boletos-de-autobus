...
<head>
  ...
  <title>Costaline | Ver Autobus</title>
...
Panel de control
      ...
      <ol class="breadcrumb">
        <li><a href="verAutobus.php"><i class="fa fa-dashboard"></i>Visualizar</a></li>
        <li><a href="verAutobus.php"><i class="fa fa-dashboard"></i>Autobus</a></li>
        ...
        <div class="col-lg-12 ">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Autobuses Registrados</h3>
            </div>
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    $consulta = mysqli_query($conexion,"SELECT * FROM autobus");

                    while ($linea = mysqli_fetch_array($consulta)){
                    echo "
                      <tr>
                        <td>".$linea['idautobus']."</td><td>".$linea['tipo']."</td><td>".$linea['capacidad']."</td>
                      </tr>";
                    }
}
                     ?>
