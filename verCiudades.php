...
<head>
  ...
  <title>Costaline | Ver Ciudades</title>
...
Panel de control
      ...
      <ol class="breadcrumb">
        <li><a href="verCiudades.php"><i class="fa fa-dashboard"></i>Visualizar</a></li>
        <li><a href="verCiudades.php"><i class="fa fa-dashboard"></i>Ciudades</a></li>
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    $consulta = mysqli_query($conexion,"SELECT * FROM ciudad");

                    while ($linea = mysqli_fetch_array($consulta)){
                    echo "
                      <tr>
                        <td>".$linea['idciudad']."</td><td>".$linea['nombreCiudad']."</td>
                      </tr>";
                    }
}
                     ?>
