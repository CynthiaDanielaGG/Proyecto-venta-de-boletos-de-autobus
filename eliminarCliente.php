...
<head>
  ...
  <title>Costaline | Eliminar Cliente </title>
...
Panel de control
      ...
      <ol class="breadcrumb">
        <li><a href="eliminarCliente.php"><i class="fa fa-dashboard"></i>Eliminar Cliente</a></li>
        ...
        <div class="col-lg-6 ">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Introduce el "nombre de usuario" del cliente a eliminar</h3>
            </div>
            <form role="form">
              <div class="box-body">
...
if(isset($_REQUEST['buscar'])){
  ...
  if ($searchName !="") {
    ...
    if (mysqli_connect_errno()) {
      ...
      $consulta=mysqli_query($conexion,"SELECT * FROM usuario where nombreUsuario='".$searchName."' AND tipo='cliente'");
      $row = $consulta->fetch_array(MYSQLI_NUM);
      if ($row[1]==$searchName) {
        $sql1="SELECT * FROM usuario where nombreUsuario='".$searchName."' AND tipo='cliente'";
            ...
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombre" name="nombrephp" value="'.$row2[1].'" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Apellido Paterno</label>
                  <input type="text" class="form-control" id="apellidoPat" name="apellidoPatphp" value="'.$row2[2].'" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Apellido Materno</label>
                  <input type="text" class="form-control" id="apellidoMat" name="apellidoMatphp" value="'.$row2[3].'" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Fecha de nacimiento</label>
                  <input type="text" class="form-control" id="fechaNac" name="fechaNacphp" value="'.$row2[4].'" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre de usuario</label>
                  <input type="text" class="form-control" id="nombreUsuario" name="nombreUsuariophp" value="'.$row[1].'" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Contraseñia</label>
                  <input type="text" class="form-control" id="contrasenia" name="contraseniaphp" value="'.$row[2].'" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Numero de Tarjeta</label>
                  <input type="text" class="form-control" id="numtarjeta" name="numtarjetaphp" value="'.$row3[0].'" disabled>
                </div>
...
$actualizacionUsuario = "DELETE FROM usuario WHERE idusuario=".$row1[0]."";
$actualizacionDatos = "DELETE FROM datospersonales WHERE id_usuario=".$row1[0]."";
$actualizacionTarjeta = "DELETE FROM tarjeta WHERE id_cliente=".$row1[0]."";
