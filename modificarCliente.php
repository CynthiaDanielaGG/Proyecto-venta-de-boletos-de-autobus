...
<head>
  ...
  <title>Costaline | Modificar Cliente </title>
...
Panel de control
      ...
      <ol class="breadcrumb">
        <li><a href="modificarCliente.php"><i class="fa fa-dashboard"></i>Modificar Clientes</a></li>
        ...
        <div class="col-lg-6 ">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Introduce el "nombre de usuario" del cliente a modificar</h3>
            </div>
            <form role="form">
              <div class="box-body">
