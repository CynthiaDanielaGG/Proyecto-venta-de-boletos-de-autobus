...
<head>
  ...
  <title>Costaline | Ver Cliente </title>
...
Panel de control
      ...
      <ol class="breadcrumb">
        <li><a href="verCliente.php"><i class="fa fa-dashboard"></i>Visualizar</a></li>
        <li><a href="verCliente.php"><i class="fa fa-dashboard"></i>Clientes</a></li>
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    $consulta = mysqli_query($conexion,"SELECT idusuario,nombre,apellidoPaterno,apellidoMaterno,fechaNacimiento,nombreUsuario,contrasenia,numeroTarjeta FROM usuario INNER JOIN datospersonales ON idusuario = id_usuario INNER JOIN tarjeta ON idusuario=id_cliente WHERE tipo='cliente'");

                    while ($linea = mysqli_fetch_array($consulta)){
                    echo "
                      <tr>
                        <td>".$linea['idusuario']."</td><td>".$linea['nombre']."</td><td>".$linea['apellidoPaterno']."</td><td>".$linea['apellidoMaterno']."</td><td>".$linea['fechaNacimiento']."</td><td>".$linea['nombreUsuario']."</td><td>".$linea['contrasenia']."</td><td>".$linea['numeroTarjeta']."</td>
                      </tr>";
                    }
