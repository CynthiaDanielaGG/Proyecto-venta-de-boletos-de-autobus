...
<head>
  ...
  <title>Costaline | Ver Corridas</title>
...
Panel de control
      ...
      <ol class="breadcrumb">
        <li><a href="verCorridas.php"><i class="fa fa-dashboard"></i>Visualizar</a></li>
        <li><a href="verCorridas.php"><i class="fa fa-dashboard"></i>Corridas</a></li>
        ...
        <div class="col-lg-12 ">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Corridas Registradas</h3>
            </div>
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    $consulta = mysqli_query($conexion,"SELECT idcorrida,o.nombreCiudad,c.nombreCiudad, hora_salida, hora_llegada, fecha_salida, costo, id_autobus,nombre FROM corrida INNER JOIN ciudad o ON o.idciudad = id_origen INNER JOIN datospersonales ON id_chofer=id_usuario INNER JOIN ciudad c ON c.idciudad=id_destino");

                    while ($linea = mysqli_fetch_row($consulta) ){
                    echo "
                      <tr>
                        <td>".$linea[0]."</td><td>".$linea[1]."</td><td>".$linea[2]."</td><td>".$linea[3]."</td><td>".$linea[4]."</td>
                        <td>".$linea[5]."</td><td>".$linea[6]."</td><td>".$linea[7]."</td><td>".$linea[8]."</td>
                      </tr>";
                    }
}
                     ?>
